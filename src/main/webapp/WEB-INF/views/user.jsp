                                    ...
                                    <tbody>
                                        <c:forEach items="${users}" var="user">
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a href="<c:url value='/admin/users/edit/${user.email}'/>" class="btn btn-info btn-sm">
                                                            <i class="fa fa-edit"></i>
                                                        </a>
                                                        <form action="<c:url value='/admin/users/delete/${user.email}'/>" method="POST" class="d-inline" onsubmit="return confirm('Bạn có chắc chắn muốn xóa người dùng này?');">
