...
<head>
    ...
    <title>TechStore Admin - Thêm voucher</title>
                ...
                <div class="page-inner">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form:form action="/admin/vouchers/add" method="post" modelAttribute="voucher" id="voucherForm">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <form:input path="code" class="form-control" required="required" 
                                                      pattern="[A-Za-z0-9-_]+" 
                                                      title="Mã voucher chỉ được chứa chữ cái, số, dấu gạch ngang và gạch dưới"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <form:select path="type" class="form-control" required="required">
                                                <form:option value="">-- Chọn loại voucher --</form:option>
