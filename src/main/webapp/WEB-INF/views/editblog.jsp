...
<head>
    ...
    <title>TechStore Admin - Chỉnh sửa bài viết</title>
                ...
                <div class="page-inner">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="<c:url value='/admin/blogs/edit/${blog.id}'/>" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <c:if test="${not empty blog.imageUrl}">
                                                <div class="mb-2">
                                                    <img src="${blog.imageUrl}" alt="${blog.title}" style="max-width: 200px; max-height: 200px;">
                                                </div>
                                            </c:if>
