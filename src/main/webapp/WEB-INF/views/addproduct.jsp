...
<head>
    ...
    <title>TechStore Admin - Thêm sản phẩm</title>
                ...
                <div class="page-inner">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form:form action="/admin/products/add" method="post" modelAttribute="product" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <form:input path="price" type="number" class="form-control" required="required" min="0" step="0.01"/>
                                        ...
                                        <div class="form-group">
                                            <label for="imageFile">Hình ảnh <span class="text-danger">*</span></label>
                                            <input type="file" name="imageFile" class="form-control" required="required" accept="image/*"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <form:input path="trademark" class="form-control"/>
